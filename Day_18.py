...
we continue dequeueing, popping, and comparing each character until our containers 
...
Write the following declarations and implementations:
    ...
    4. A char popCharacter() method that pops and returns the character 
        at the top of the stach instance variable.
...
Output:
    ...
    If your code is correctly written and s is a palindrome, the locked stub code will 
    print The word, s, is a palindrome.; otherwise, it will print
