...
Objective:
    ...
    Tutorial tab for learning materials and instructional video!

Task:
    COnsider the database table, Email, which has the attributes First Name
...
Input Format:
    The first line contains an integer, N, total number of rows in
    the table.
    Each of the N subsequent lines contain 2 space-separated strings
    denoting a person's first name and email ID, respectively.

Constraints:
    2 <= 30
    Each of first names consists of lower case letters [a-z] only.
