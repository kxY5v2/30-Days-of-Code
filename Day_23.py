...
Objective:
    ...
    tutorial tab for learning materials and an instruction video!
...
Task:
    ...
    binary search tree. Complete the levelOrder function provided in 
    your editor so that it prints the level-order traversal of the binary 
    search tree.
...
Print:
    - Print node.data items as space-separated line of integers. 
...
Explanation:
    ...
    The resulting level-order traversal is 
        3 -> 2 -> 5 -> 1 -> 4 -> 7  
    and we print these data values as a single line of space-separated 
    integers.
'''
