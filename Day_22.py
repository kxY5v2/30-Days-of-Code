...
Task:
    ...
    between the tree's root and its furthest leaf. You are given a 
...
Input Format:
    ...
    The first line contains an integer, n, denoting the number of nodes
        in the tree,
    Each of the n subsequent lines contains and integer, data, denoting
        the value of an element that must be added to the BST.

Output Format:
    The locked stub code in your editor will print the integer returned
    by your getHeight function denoting the height of the BST.  
...
Explanation:
    ...
    meaning out BST's height = 3. Thus we print 3 as our answer.                       
'''
