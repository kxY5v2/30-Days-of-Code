...
Task:
    A class is provided for you in the editor. A Node object has an 
    ...
    removeDuplicates so that it deleted any duplicate nodes from the list
...
Input Format:
    ...
    handled by the locked stub code and passed to the removeDuplicates function:
        The first line contains an integer, N, the number of nodes to be inserted.
        The N subsequent lines each contain an integer describing the data
        valie of a node being inserted at the list's tail.
